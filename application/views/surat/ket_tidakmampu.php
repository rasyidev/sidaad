  ...
  <div class="container">
    <div class="row justify-content-center">
      ...
      <form action="<?= base_url('letter/index_sktm.php') ?>" method="post" class="col col-10 col-md-8">
        ...
        <div class="form-group">
          <input type="text" class="form-control" name="kewarganegaraan" id="kewarganegaraan" aria-describedby="helpId" placeholder="Warga Negara" value="<?php if ($this->uri->segment(3) == $penduduk['nik']) {
                                                                                                                                                            echo $penduduk['kewarganegaraan'];
                                                                                                                                                          } ?>">
        </div>
        <div class="form-group">
        ...
        <button type="submit" class="btn btn-primary">Buat SKTM</button>
      </form>
    </div>
  </div>
  <br><br>
